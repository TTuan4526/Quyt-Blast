...
namespace PathologicalGames
{
    ...
    public sealed class SpawnPool : MonoBehaviour, IList<PoolPrefab>
    {
        ...
        internal List<PoolPrefab> _spawned = new List<PoolPrefab>();
        ...
        public void Add(PoolPrefab instance, string prefabName, bool despawn, bool parent)
        {
            for (int i = 0; i < this._prefabPools.Count; i++)
            {
                ...
                if (this._prefabPools[i].prefabGO.name == prefabName)
                {
                    ...
                    if (parent) 
					{
						...
						instance.transform.SetParent(this.group, worldPositionStays);
					}
        ...
        public void Add(PoolPrefab item)
        {
        ...
        /// </summary>
        /// <param name="item"></param>
        public void Remove(PoolPrefab item)
        {
        ...
        /// </returns>
        public PoolPrefab Spawn(Transform prefab, Vector3 pos, Quaternion rot, Transform parent)
        {
            PoolPrefab inst;
            ...
            for (int i = 0; i < this._prefabPools.Count; i++)
            {
                ...
                if (this._prefabPools[i].prefabGO == prefab.gameObject)
                {
                    ...
                    inst = this._prefabPools[i].SpawnInstance(pos, rot).GetComponent<PoolPrefab>();
					...
					{
						inst.transform.SetParent(parent, worldPositionStays);
					}
                    else if (!this.dontReparent && inst.transform.parent != this.group)  // Auto organize?
					{
						// If a new instance was created, it won't be grouped
						inst.transform.SetParent(this.group, worldPositionStays);
					}
            ...
            PrefabPool newPrefabPool = new PrefabPool(prefab.GetComponent<PoolPrefab>());
        ...
        /// </summary>
        public PoolPrefab Spawn(Transform prefab, Vector3 pos, Quaternion rot)
        {
            PoolPrefab inst = this.Spawn(prefab, pos, rot, null);
        ...
        /// </summary>
        public PoolPrefab Spawn(Transform prefab)
        {
        ...
        /// </summary>
        public PoolPrefab Spawn(Transform prefab, Transform parent)
        {
		...
		public PoolPrefab Spawn(GameObject prefab, Vector3 pos, Quaternion rot, Transform parent)
		{
			return Spawn(prefab.transform, pos, rot, parent);
		}
		
		public PoolPrefab Spawn(GameObject prefab, Vector3 pos, Quaternion rot)
		{
			return Spawn(prefab.transform, pos, rot);
		}
		
		public PoolPrefab Spawn(GameObject prefab)
		{
			return Spawn(prefab.transform);
		}
		
		public PoolPrefab Spawn(GameObject prefab, Transform parent)
		{
        ...
        /// </summary>
        public PoolPrefab Spawn(string prefabName)
        {
            PoolPrefab prefab = this.prefabs[prefabName];
        ...
        /// instance under the given parent
        /// </summary>
        public PoolPrefab Spawn(string prefabName, Transform parent)
        {
            PoolPrefab prefab = this.prefabs[prefabName];
        ...
        /// position and rotation.
        /// </summary>
        public PoolPrefab Spawn(string prefabName, Vector3 pos, Quaternion rot)
        {
            PoolPrefab prefab = this.prefabs[prefabName];
                            	 ...
                            	 Transform parent)
        {
            ...
            PoolPrefab inst = Spawn(prefab.transform, pos, rot, parent);
                                    ...
                                    Transform parent)
        {
            ...
            PoolPrefab inst = this.Spawn(prefab.transform, pos, rot, parent);
        ...
        public void Despawn(PoolPrefab instance)
        {
        ...
        /// just before despawn.
        /// </summary>
        public void Despawn(PoolPrefab instance, Transform parent)
        {
			// Spawn the new instance (Note: prefab already set in PrefabPool)
        ...
        public void Despawn(PoolPrefab instance, float seconds)
        {
        ...
        /// just before despawn.
        /// </summary>
        public void Despawn(PoolPrefab instance, float seconds, Transform parent)
        {
        ...
        /// </summary>
        private IEnumerator DoDespawnAfterSeconds(PoolPrefab instance, float seconds, bool useParent, Transform parent)
        {
        ...
        {
            var spawned = new List<PoolPrefab>(this._spawned);
        ...
        public bool IsSpawned(PoolPrefab instance)
        {
        ...
        public PrefabPool GetPrefabPool(PoolPrefab prefab)
        {
            for (int i = 0; i < this._prefabPools.Count; i++)
            {
                if (this._prefabPools[i].prefabGO == null)
        ...
        /// <returns>Transform</returns>
        public PoolPrefab GetPrefab(PoolPrefab instance)
        {
            for (int i = 0; i < this._prefabPools.Count; i++)
        ...
        {
            for (int i = 0; i < this._prefabPools.Count; i++)
                if (this._prefabPools[i].Contains(instance.GetComponent<PoolPrefab>()))
        ...
        private IEnumerator ListForAudioStop(AudioSource src)
        {
            ...
            this.Despawn(src.GetComponent<PoolPrefab>());
        }
        ...
        private IEnumerator ListenForEmitDespawn(ParticleSystem emitter)
        {
			...
			{
				this.Despawn(emitter.GetComponent<PoolPrefab>());
				emitter.Clear(true);
			}
        }
        ...
        public override string ToString()
        {
            ...
            foreach (PoolPrefab item in this._spawned)
        ...
        /// <returns></returns>
        public PoolPrefab this[int index]
        {
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public bool Contains(PoolPrefab item)
        {
        ...
        /// </param>
        public void CopyTo(PoolPrefab[] array, int arrayIndex)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerator<PoolPrefab> GetEnumerator()
        {
        ...
        // Not implemented
        public int IndexOf(PoolPrefab item) { throw new System.NotImplementedException(); }
        public void Insert(int index, PoolPrefab item) { throw new System.NotImplementedException(); }
        ...
        bool ICollection<PoolPrefab>.Remove(PoolPrefab item) { throw new System.NotImplementedException(); }
    ...
    public class PrefabPool
    {
        ...
        /// </description>
        public PrefabPool(PoolPrefab prefab)
        {
            this.prefab = prefab;
        ...
        internal void inspectorInstanceConstructor()
        {
            ...
            this._spawned = new List<PoolPrefab>();
            this._despawned = new List<PoolPrefab>();
        }
        ...
        /// </summary>
        internal List<PoolPrefab> _spawned = new List<PoolPrefab>();
        public List<PoolPrefab> spawned { get { return new List<PoolPrefab>(this._spawned); } }
        ...
        /// Managed by a SpawnPool
        /// </summary>
        internal List<PoolPrefab> _despawned = new List<PoolPrefab>();
        public List<PoolPrefab> despawned { get { return new List<PoolPrefab>(this._despawned); } }
        ...
        /// </returns>
        internal bool DespawnInstance(PoolPrefab xform)
        {
            return DespawnInstance(xform, true);
        }

        internal bool DespawnInstance(PoolPrefab xform, bool sendEventMessage)
        {
            if (this.logMessages)
        ...
        internal IEnumerator CullDespawned()
        {
            ...
            while (this.totalCount > this.cullAbove)
            {
                ...
                for (int i = 0; i < this.cullMaxPerPass; i++)
                {
                    ...
                    {
                        PoolPrefab inst = this._despawned[0];
        ...
        /// reached.
        /// </returns>    
        internal PoolPrefab SpawnInstance(Vector3 pos, Quaternion rot)
        {
            ...
            {
                PoolPrefab firstIn = this._spawned[0];
        ...
        /// reached.
        /// </returns>
        public PoolPrefab SpawnNew() { return this.SpawnNew(Vector3.zero, Quaternion.identity); }
        public PoolPrefab SpawnNew(Vector3 pos, Quaternion rot)
        {
            ...
            PoolPrefab inst = instGO.GetComponent<PoolPrefab>();
            ...
            if (!this.spawnPool.dontReparent)
			{
				...
				inst.transform.SetParent(this.spawnPool.group, worldPositionStays);
			}
            ...
            if (this.spawnPool.matchPoolLayer)
                this.SetRecursively(inst.transform, this.spawnPool.gameObject.layer);
        ...
        internal void AddUnpooled(PoolPrefab inst, bool despawn)
        {
            this.nameInstance(inst);   // Adds the number to the end
        ...
        public bool Contains(PoolPrefab transform)
        {
        ...
        private void nameInstance(PoolPrefab instance)
        {
    ...
    public class PrefabsDict : IDictionary<string, PoolPrefab>
    {
        ...
        internal void _Add(string prefabName, PoolPrefab prefab)
        {
        ...
        private Dictionary<string, PoolPrefab> _prefabs = new Dictionary<string, PoolPrefab>();
        ...
        /// <returns></returns>
        public bool TryGetValue(string prefabName, out PoolPrefab prefab)
        {
        ...
        public void Add(string key, PoolPrefab value)
        {
        ...
        public bool Contains(KeyValuePair<string, PoolPrefab> item)
        {
            string msg = "Use Contains(string prefabName) instead.";
            throw new System.NotImplementedException(msg);
        }

        public PoolPrefab this[string key]
        {
            get
            {
                PoolPrefab prefab;
        ...
        public ICollection<PoolPrefab> Values
        {
            get
            {
        ...
        bool ICollection<KeyValuePair<string, PoolPrefab>>.IsReadOnly { get { return true; } }

        public void Add(KeyValuePair<string, PoolPrefab> item)
        {
            throw new System.NotImplementedException("Read-only");
        }
        ...
        private void CopyTo(KeyValuePair<string, PoolPrefab>[] array, int arrayIndex)
        {
            string msg = "Cannot be copied";
            throw new System.NotImplementedException(msg);
        }

        void ICollection<KeyValuePair<string, PoolPrefab>>.CopyTo(KeyValuePair<string, PoolPrefab>[] array, int arrayIndex)
        {
            string msg = "Cannot be copied";
            throw new System.NotImplementedException(msg);
        }

        public bool Remove(KeyValuePair<string, PoolPrefab> item)
        {
            throw new System.NotImplementedException("Read-only");
        }
        ...
        public IEnumerator<KeyValuePair<string, PoolPrefab>> GetEnumerator()
        {
